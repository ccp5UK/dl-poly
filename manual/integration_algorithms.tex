...
ensemble by imposing a Gaussian cosntraint on the system's intsanteneous temperature,
changes to:
\begin{eqnarray}
...
\end{eqnarray}
where $E_{kin}$ contains both the kinetic contribution form the free particles and the
RBs' COMs.
