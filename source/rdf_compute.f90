...
! amended   - i.t.todorov january 2008
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
! exclude the ones absent crystallographically

  Do ia=1,ntpatm
     If (numtyp(ia) > zero_plus) Then
        Do ib=ia,ntpatm
           If (numtyp(ib) > zero_plus) Then
...
! normalisation factor
                 ...
                 If (ia == ib .and. Nint(numtyp(ia)) > 1) &
                    factor=factor*0.5_wp ! *(1.0_wp-1.0_wp/numtyp(ia))
