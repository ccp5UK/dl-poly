...
!       (1) ewald_spme_mforc~s.f90 is not dependent on exchange_grid.f90
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  Integer              :: fail(1:4), i,j,k,l, jj,kk,ll, jjb,jjt, kkb,kkt, llb,llt, &
                          k1,k2,k3,s1,s2,s3,m,n,ks1,ks2,ks3, mm,nn
...
! allocate the global charge arrays (NOT deallocated manually)
     ...
     If (Any(fail > 0)) Then
        Write(nrite,'(/,1x,a,i0)') 'qtc,qqq,qqc,qt1,qt2,qt3, workspace arrays allocation failure, node: ', idnode
        Call error(0)
     End If
...
! calculating inverse 3D FFT of generalized multipolar array (in place)
  ...
  Call dlpfft3(1,kmaxa,kmaxb,kmaxc,ww1,ww2,ww3,qt1)
  Call dlpfft3(1,kmaxa,kmaxb,kmaxc,ww1,ww2,ww3,qt2)
  Call dlpfft3(1,kmaxa,kmaxb,kmaxc,ww1,ww2,ww3,qt3)
