...
Contains
  ...
  Subroutine GPFA(A, B, Trigs, Inc, Jump, N, Lot, Isign)
    ...
    Integer :: i, ifac, iq, ir, kk, li, ll, nj(3), nn
  ...
  Subroutine GPFA2F(A, B, Trigs, Inc, Jump, N, Mm, Lot, Isign)
    ...
    Integer       :: ink, inq, ipass, istart, j, ja, jb, jc, jd, je, jf, jg, jh, ji, jj, jjj, jk, &
                     jl, jm, jn, jo, jp, jstep, jstepl, jstepx, k, kk, l, la, laincl, left, ll, &
                     lvr, m, m2, m8, mh, mu, n2, nb, nblox, ninc, nu, nvex
    Real(Kind=wp) :: aja, ajb, ajc, ajd, aje, ajf, ajg, ajh, aji, ajj, ajk, ajl, ajm, ajn, ajo, &
                     ajp, bja, bjb, bjc, bjd, bje, bjf, bjg, bjh, bji, bjj, bjk, bjl, bjm, bjn, &
                     bjo, bjp, c1, c2, c3, co1, co2, co3, co4, co5, co6, co7, s, si1, si2, si3, &
                     si4, si5, si6, si7, ss, t0, t1, t2, t3, u0, u1, u2, u3
  ...
  Subroutine GPFA3F(A, B, Trigs, Inc, Jump, N, Mm, Lot, Isign)
    ...
    Integer       :: ink, inq, ipass, istart, j, ja, jb, jc, jd, je, jf, jg, jh, ji, jjj, jstep, &
                     jstepl, jstepx, k, kk, l, la, laincl, left, ll, lvr, m, mh, mu, n3, nb, &
                     nblox, ninc, nu, nvex
    Real(Kind=wp) :: aja, ajb, ajc, ajd, aje, ajf, ajg, ajh, aji, bja, bjb, bjc, bjd, bje, bjf, &
                     bjg, bjh, bji, c1, co1, co2, s, si1, si2, t1, t2, t3, u1, u2, u3
  ...
  Subroutine GPFA5F(A, B, Trigs, Inc, Jump, N, Mm, Lot, Isign)
    ...
    Integer, Parameter       :: ncache = 65536
    Real(Kind=wp), Parameter :: qrt5 = 0.559016994374947_wp, sin36 = 0.587785252292473_wp, &
                                sin72 = 0.951056516295154_wp

    Integer       :: ink, inq, ipass, istart, j, ja, jb, jc, jd, je, jf, jg, jh, ji, jj, jjj, jk, &
                     jl, jm, jn, jo, jp, jq, jr, js, jstep, jstepl, jstepx, jt, ju, jv, jw, jx, &
                     jy, k, kk, l, la, laincl, left, ll, lvr, m, mh, mu, n5, nb, nblox, ninc, nu, &
                     nvex
    Real(Kind=wp) :: aja, ajb, ajc, ajd, aje, ajf, ajg, ajh, aji, ajj, ajk, ajl, ajm, ajn, ajo, &
                     ajp, ajq, ajr, ajs, ajt, aju, ajv, ajw, ajx, ajy, ax, bja, bjb, bjc, bjd, &
                     bje, bjf, bjg, bjh, bji, bjj, bjk, bjl, bjm, bjn, bjo, bjp, bjq, bjr, bjs, &
                     bjt, bju, bjv, bjw, bjx, bjy, bx, c1, c2, c3, co1, co2, co3, co4, s, si1, &
                     si2, si3, si4, t1, t10, t11, t2, t3, t4, t5, t6, t7, t8, t9, u1, u10, u11, &
  ...
  Subroutine SETGPFA(Trigs, N)
    ...
    Integer       :: i, ifac, iq, ir, irot, k, kink, kk, li, ll, ni, nj(3), nn
