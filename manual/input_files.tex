...
simultaneously).  They are shorthanded as {\bf ters} and {\bf hiks}
atomkeys.
\begin{itemize}
\item {\bf ters} atomkey expects $2n$ records specifying $n$ particular
Tersoff single atom type parameters and $n(n+1)/2$ records specifying
...
\item {\bf hiks} atomkey expects $3n$ records specifying $n$ particular
Tersoff single atom type parameters in the following manner:
