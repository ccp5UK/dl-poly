...
implementation within DL_POLY_5 that incorporates these electronic
excitations.
...
TTM with MD (2T-MD) has been implemented in DL_POLY_5 to take advantage
...
information is provided, DL_POLY_5 will use default values for certain
required properties, but some information *must* be provided: if this
information is unavailable, DL_POLY_5 will terminate. The list of TTM
...
model, but DL_POLY_5 will quit with an error message if TTM is selected
...
as CIT or larger: too few CET voxels will cause DL_POLY_5 to terminate.
...
DL_POLY_5 will assume a constant volumetric heat capacity of 1
