Module constraints
  ...
  Use timer, Only   : start_timer_new, stop_timer_new, timer_type
...
Contains
  ...
  Subroutine constraints_rattle(tstep,lfst,lcol,config,stat,cons,domain,tmr,comm)
...
#ifdef CHRONO
    Call start_timer_new('Rattle Constraints')
#endif
    fail=0
    ...
    End If
#ifdef CHRONO
    Call stop_timer_new('Rattle Constraints')
#endif
  ...
  Subroutine constraints_shake_vv(tstep,config,str,vir,stat,cons,domain,tmr,comm)
    ...
    Character(Len=256) :: message
#ifdef CHRONO
    Call start_timer_new('SHAKE Constraints')
#endif
    fail=0
...
#ifdef CHRONO
    Call stop_timer_new('SHAKE Constraints')
#endif
