...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  If (Any(fail > 0)) Then
     Write(nrite,'(/,1x,a,i0)') 'npt_b0 allocation failure, node: ', idnode
     Call error(0)
  End If
...
! estimate chit and kinetics at full step - nvt_b0_scl
  ...
  If (Any(fail > 0)) Then
     Write(nrite,'(/,1x,a,i0)') 'npt_b0 deallocation failure, node: ', idnode
     Call error(0)
  End If

End Subroutine npt_b0_lfv
