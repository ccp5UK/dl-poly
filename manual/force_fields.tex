...
\subsection{Breathing Shell Extension}

While for low-symmetry structures, the conventional, dipolar rigid
shell model (RSM) 'Gale77' is sufficient to absorb most of the
effects of partial covalency/ionic polarisation, for some high-symmetry
systems, a breathing shell model (BSM) 'Schroeder 1966' is used as
...
$r_{i}^{o}$, which is allowed to deform isotropically under its environment.
