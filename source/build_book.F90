...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  If (.not.(newjob .or. lsim)) Call init_intra(cons,pmf,bond,angle,dihedral,inversion,tether)
...
Subroutine init_intra(cons,pmf,bond,angle,dihedral,inversion,tether)
