...
Contains
  ...
  ! uni is the diagonal unit matrix
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nst_h0 allocation failure'
  ...
  ! update kinetic energy and stress
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nst_h0 deallocation failure'
       Call error(0,message)
    End If
  ...
  ! uni is the diagonal unit matrix
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nst_h1 allocation failure'
       Call error(0,message)
    End If
  ...
  ! update kinetic energy and stress
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nst_h1 deallocation failure'
       Call error(0,message)
    End If
