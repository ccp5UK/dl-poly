...
DL\_POLY\_2 (written by Bill Smith \& Tim Forester) and \D (written
...
exploiting parallelism.  DL\_POLY\_2 uses a Replicated Data (RD)
...
a DL\_POLY\_2 to a \D simulation with little effort.  It should
be apparent from these comments that \D is not intended as a
replacement for DL\_POLY\_2.
...
DL\_POLY\_2, which is written in the Java\textregistered programming
...
(FIQA) \cite{fincham-92a} under the LF scheme or with the
...
\item Langevin\index{ensemble!Langevin NPT} constant T,P algorithm \cite{quigley-04}
...
\item Langevin\index{ensemble!Langevin N$\sigma$T} constant T,$\sigma$ algorithm \cite{quigley-04}
...
\subsection{DL\_POLY\_2 features incompatible or unavalable in \D\index{dlpoly2}}
...
access the same source code.  For information on CVS\index{CVS}
please contact \\
\noindent \href{mailto:info-cvs-request@gnu.org}{info-cvs-request@gnu.org}
or visit the web site - \href{http://www.cyclic.com/}{http://www.cyclic.com/}\index{WWW}.
...
\begin{enumerate}
\item A CVS\index{CVS} revision number and associated data
...
routines in this sub-directory are documented in the DL\_POLY\_2
...
Interface} is based on the Java language developed by Sun.  The
...
\href{http://java.sun.com/}{http://java.sun.com/}\index{WWW}.
...
\section{Obtaining the Source Code}\index{user registration} \index{\D software licence}
...
\noindent{\href{mailto:ilian.todorov@stfc.ac.uk}{ilian.todorov@stfc.ac.uk}}
