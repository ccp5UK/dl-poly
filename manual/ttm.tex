...
The stochastic force $\vek{R}_{p}(t)$ returns energy from the
...
If the system is metallic (specified by the CONTROL directive {\bf ttm\_metal} as on),
...
If the {\bf ttm\_redistribute} option is in use, any recently deactivated voxels
