...
#ifdef WITH_DFTBP
  Use dftbp_library,        Only: run_dftbplus,&
                                  dftb_geometry_type,&
                                  convert_unit
#endif
...
Contains
  ...
  Subroutine calculate_dftb_forces(comm, flow, config)
    ...
    !Note: Only need to tear down when atomic distribution changes
    !but do this for now 
