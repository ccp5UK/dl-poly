...
\begin{eqnarray}
V_{ij}(r_{ij}) &=& 0 \nonumber \\
\rho_{ij}(r_{ij}) &=& \frac{a}{r_{ij}^{m}} \\
F(\rho_{i}) &=& -\epsilon \sqrt{\rho_{i}}~~, \nonumber
\end{eqnarray}
with parameters: $\epsilon$, $a$ and $m$.
\end{enumerate}
...
particle participating in the interaction!  Hence the angular term
is more complicated and difficult to express than in the {\bf ters} case:
%\begin{eqnarray}
%\ell~=~i~&:&~\frac{\partial}{\partial r_{i}^{\alpha}} {\cal{L}}_{ij} = \sum_{k \neq i,j} \omega_{ik}
%\left[ g(\theta_{ijk}) \frac{\partial}{\partial r_{i}^{\alpha}} f_{C}(r_{ik}) +
%f_{C}(r_{ik}) \frac{\partial}{\partial r_{i}^{\alpha}} g(\theta_{ijk}) \right] \nonumber \\
...
%\ell~\neq~i,j~&:&~\frac{\partial}{\partial r_{\ell}^{\alpha}} {\cal{L}}_{ij} = \omega_{i \ell}
%\left[ g(\theta_{ij \ell}) \frac{\partial}{\partial r_{\ell}^{\alpha}} f_{C}(r_{i \ell}) +
%f_{C}(r_{i \ell})~\times \right. \\
%& & \phantom{xxxxxxxxxxxxxxxxx} \left. \times~\left( -\alpha_{i}~\beta_{i}~(r_{ij}-r_{ik})^{\beta_{i}-1} g(\theta_{ij \ell})
%+ \frac{\partial}{\partial r_{\ell}^{\alpha}} g(\theta_{ij \ell}) \right) \right]~~. \nonumber
%\end{eqnarray}
\end{itemize}
