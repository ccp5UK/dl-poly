...
\subsubsection*{\underline{Message 678}: error - cannot find or open coupling constant table file (g.dat)}
...
\subsubsection*{\underline{Message 679}: error - no data found in coupling constant table file (g.dat)}
...
\subsubsection*{\underline{Message 680}: error - end of file encountered in table file (Ke.dat, Ce.dat or g.dat)}

\D encountered the end of one of the tabulated files (Ke.dat, Ce.dat or g.dat) 
...
\subsubsection*{\underline{Message 681}: error - negative electronic temperature: instability in electronic heat diffusion equation}
...
\subsubsection*{\underline{Message 682}: error - electronic temperature restart file (DUMP\_E) does not exist}
...
\subsubsection*{\underline{Message 683}: error - mismatch in electronic temperature lattice sizes between restart (DUMP\_E) and CONTROL files}
...
\subsubsection*{\underline{Message 684}: error - cannot read electronic temperature restart (DUMP\_E) file}
