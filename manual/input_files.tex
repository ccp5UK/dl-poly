...
(DD) parallelisation strategy of it.  However, this is not restriction
for the replicated data parallelisation \C adopts and thus \D can also
accept truncated octahedral and rhombic dodecahedral periodic boundaries.
