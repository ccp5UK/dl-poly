...
\item {\bf ttm laser} $F$ $l_p$ {\bf zdep}: specifies a homogeneous distribution in x- and y-directions with exponential decay in the z-direction \begin{equation*}f(r,z) = \frac{F}{l_p} \exp\left(-\frac{z}{l_p}\right) \end{equation*} using the penetration depth as the scaling factor for z-direction decay.
\end{itemize}
