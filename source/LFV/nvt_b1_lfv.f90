...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  If (Any(fail > 0)) Then
     Write(nrite,'(/,1x,a,i0)') 'nvt_b1 allocation failure, node: ', idnode
     Call error(0)
  End If
...
! estimate chit and kinetics at full step - nvt_b1_scl
  ...
  If (Any(fail > 0)) Then
     Write(nrite,'(/,1x,a,i0)') 'nvt_b1 deallocation failure, node: ', idnode
     Call error(0)
  End If

End Subroutine nvt_b1_lfv
