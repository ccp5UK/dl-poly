Module nve
  ...
  Use setup,         Only : mxcons,mxpmf,mxtpmf,mxatms,zero_plus
...
Contains
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nve_0 allocation failure'
  ...
  ! update kinetic energy and stress
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nve_0 deallocation failure'
       Call error(0,message)
    End If
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nve_1 allocation failure'
       Call error(0,message)
    End If
  ...
  ! update rotational energy
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nve_1 deallocation failure'
       Call error(0,message)
    End If
