...
\subsection{Dissipative Particle Dynamics Thermostat}
...
respectively, using Suzuki-Trotter(Strang) expansion of the Lioville
...
If we define the velocity Verlet microcsannonical (NVE) ensemble sequence as
