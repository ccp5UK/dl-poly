...
! CONFIG MODULE
  ...
  Use config_module, Only : natms,nlast,lsi,lsa,ltg,lfrzn
...
! MULTIPOLES MODULE
  ...
  Use mpoles_module, Only : keyind,lchatm ! equivalent to lexatm in config_module
...
! sort lchatm
  ...
  Do i=1,natms
     ...
     kk=kk+j
  End Do
  If (mxnode > 1) Call gsum(kk)

  If (idnode == 0) Write(nrite,'(/,1x,a,i11)') "Total of CHARMMing core-shell (scaled and dumped) cross-interatcions",kk/2
