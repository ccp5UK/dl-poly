...
\>                                              \> pulse \\
\>                                              \> \\
\> {\bf ttm diff} $f$                     \> sets constant thermal diffusivity of non-metal system to $f$ m$^2$/s \\
\>                                              \> \\
...
\>                                              \> \\
\> {\bf ttm slab}                         \> specifies slab system for \index{Two-Temperature Model}two-temperature model), in which any \\
\>                                              \> electronic energy in newly-deactivated temperature cells \\
\>                                              \> is transferred to their nearest neighbours \\
\>                                              \> \\
...
of restart timestep between REVOLD and DUMP\_E is absolutely 
necessary, but the user will be warned if they are not the same.

\subsection{The Ce.dat, Ke.dat and g.dat Files}
...
W~m$^{-1}$~K$^{-1}$ (Ke.dat) or the electron-phonon coupling constant 
in W~m$^{-3}$~K$^{-1}$ (g.dat). These files are read by the subroutine 
{\sc ttm\_table\_read} if the {\bf ttm cetab}, {\bf ttm ketab} and/or {\bf ttm gvar} 
