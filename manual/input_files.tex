...
$U(r) = 0~~~~~~~~~~~~~~~~~~~:~r \ge r_{c}$ \\
           &                           &            &          &          &                               & \\
{\bf ndpd}  & $n$DPD \cite{sokhan-23a} & $A$    & $b$      & $n$       & $r_{c}$$^{\ddagger}$                  &
$U(r) = \frac{Ab}{n+1}~r_{c}~\left(1-\frac{r}{r_{c}}\right)^{n+1}-\frac{A}{2}~r_{c}~~\left(1-\frac{r}{r_{c}}\right)^{2}~:~r < r_{c}$ \\
           &                           &            &          &          &                               &
$U(r) = 0~~~~~~~~~~~~~~~~~~~:~r \ge r_{c}$ \\
           &                           &            &          &          &                               & \\
...
\subsection{The SETEVB File}\label{sec:setevb-file}
The file SETEVB is needed for EVB simulations. If this file is not found, the execution of DL\_POLY\_4 is aborted. See section \ref{sec:setevb} for a detailed explanation of the input parameters for EVB calculations. 
