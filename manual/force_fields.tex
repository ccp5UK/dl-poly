...
OpenKIM model - \\ \href{https://openkim.org/}{https://openkim.org/}\index{WWW}.
...
code and a 3-digit version identifier \\ (e.g. \text{\bf SNAP\_ChenDengTran\_2017\_Mo\_\_MO\_698578166685\_000}).
...
ID of the IM \\ as \text{\bf https://openkim.org/id/extended\_KIM\_ID}.

For example, for the spectral neighbor analysis potential (SNAP) listed above the
Model Page is located at: \\
\href{https://openkim.org/id/SNAP_ChenDengTran_2017_Mo__MO_698578166685_000}
{https://openkim.org/id/SNAP\_ChenDengTran\_2017\_Mo\_\_MO\_698578166685\_000}\index{WWW}.

See the \href{https://openkim.org/browse/models/by-species}{current list
of KIM PMs archived in OpenKIM}\index{WWW}. This list is sorted by species
...
{(Tadmor)}\index{WWW}, KIM API
\href{https://doi.org/10.25950/FF8F563A}{(Elliott)}\index{WWW}, and the specific
...
\href{https://openkim.org/}{OpenKIM}\index{WWW}
