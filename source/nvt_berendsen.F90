...
Contains
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nvt_b0 allocation failure'
  ...
  ! update kinetic energy and stress
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nvt_b0 deallocation failure'
       Call error(0,message)
    End If
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nvt_b1 allocation failure'
       Call error(0,message)
    End If
  ...
  ! update kinetic energy and stress
    ...
    If (Any(fail > 0)) Then
       Write(message,'(/,1x,a)') 'nvt_b1 deallocation failure'
       Call error(0,message)
    End If
