...
\>                                              \> \\
\> {\bf no top}ology                            \> skip detailed topology reporting during read of FILED in OUTPUT \\
\>                                              \> (no FILED replication), useful for large bio-chemcal simulations \\
\>                                              \> \\
...
maxdis} ($0.10$~\AA) and {\bf mindis} ($0.0i3$~\AA), which can also
...
the end of equlibration (the start of statistics), $t~=0~$, is
...
By default in DL\_POLY\_Classic and \D every {\bf vdw} and {\bf met}
...
that will not be used.  (This option is not available in DL\_POLY\_Classic.)
