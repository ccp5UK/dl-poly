...
extern "C" void link_cell_pairs_cuda_initialise(
    ...
    real *aXXX, real *aYYY, real *aZZZ, int *aLFRZN,
...
//malysaght150512
  int2 lII_Bounds = make_int2(CONSTANT_DATA.mLCT_START[lIC-1+1], CONSTANT_DATA.mLCT_START[lIC+1-1+1]-1);
//end_malysaght150512
...
//malysaght150512
          int lJ_START = (lJC != lIC) ? CONSTANT_DATA.mLCT_START[lJC-1+1] : (lII+1);
          int lJ_END   = CONSTANT_DATA.mLCT_START[lJC+1-1+1]-1;
//end_malysaght150512
