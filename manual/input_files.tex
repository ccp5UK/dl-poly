...
\>                                              \> \\
\> {\bf adf} $i j$                             \> Writes Angular distribution file ADFDAT \\
\>                                              \> (Note adf cannot be used without coord present in CONTROL file) \\
\>                                              \> i = timestep interval to write to ADFDAT \\
\>                                              \> j = Precision of the Angular distribution bins\\
\>                                              \> \\
...
\>                                              \> \phantom{xxxxxxxxxxxxxxxxx} with $n$ bins and bonds cutoff of $r$ \AA \\
\>                                              \> \phantom{xxxxxxxxxxxxxxxxx} (default r~=~2~\AA). \\
\>                                              \> \\
...
\>                                              \> \\
\> {\bf close time} $f$                         \> set the amount of time a job has to finalise I/O to $f$ seconds \\
\>                                              \> (this must be smaller than the time specified by {\bf job time}, \\
\>                                              \> see Further Comments on the CONTROL File notes) \\
\>                                              \> \\
\> {\bf coord} $i j f$                          \>  Writes Coordination analysis Files ICOORD and CCOORD \\
\>                                              \> i = starting timestep for writing to files (no Defaults set) \\
\>                                              \> j = timestep interval to write to files (no Defaults set) \\
\>                                              \> f = Options available for whats is written in ICOORD and CCOORD \\
\>                                              \> option 1 : f = 0 , Only writes out ICOORD file and only dumps the  coordination of each individual atom at i\\
\>                                              \> option 2 : f = 1 , Writes out both CCOORD and ICOORD Files and only dumps the coordination of each individual atom at i\\
\>                                              \> option 3 : f =2 , Writes out both CCOORD and ICOORD files and dumps the coordination of each atom every j number of steps\\
\>                                              \> \\
...
\>                                              \> \\
\> {\bf evb}  $N_F$                    \> set an EVB simulation via the coupling of $N_F$ force-fields \\
\>                                              \> \\
...
\>                                              \> $f_{1},~f_{2}$ as the thermostat\index{thermostat} and barostat\index{barostat} relaxation times in ps \\
\>                                              \> \\
\> {\bf ensemble nst} $Q~f_{1} f_{2}$ {\bf area} \> select NP$_{n}$AT ensemble, type $Q$ (i.e. {\em lang}, {\em ber}, {\em hoover} or {\em mtk}), \\
\>                                              \> with $f_{1},~f_{2}$ as the thermostat\index{thermostat} and barostat\index{barostat} relaxation \\
\>                                              \> times in ps (for {\em lang} barostat friction in ps$^{-1}$) \\
\>                                              \> \\
...
\>                                              \> \\
\> {\bf heat\_flux}                              \> dump a HEATFLUX file containing data relevant to calculation of \\
\>                                              \> heat-flux through convolution \\
...
\>                                              \> \\
\> {\bf job time} $f$                           \> set the walltime for a job to $f$ seconds \\
\>                                              \> \\
...
\>                                              \> PLUMED calculation precision to $int$-$val$ (default \\
\>                                              \> $int$-$val$~=~$wp$ - the \D working precision) \\
\>                                              \> \\
...
\> {\bf pp\_dump}                                \> dump per-particle contributions to output file \\
\>                                              \> \\
...
\>                                              \> {\em xyrobin} $f$: Robin boundaries in x- and y-directions \\
\>                                              \> (default $f~=~0.96$), Neumann (zero) boundary in z-direction \\
\>                                              \> \\
...
\>                                              \> $f$ W~m$^{-1}$~K$^{-1}$ \\
\>                                              \> \\
\> {\bf ttm kedrude} $f$                        \> sets electronic thermal conductivity of metal system as \\
\>                                              \> Drude model ($K_{e} (T_{e}) = f \frac{T_{e}}{T_{0}}$), with value of \\
\>                                              \> $f$ W~m$^{-1}$~K$^{-1}$ at system temperature ($T_{0}$) \\
\>                                              \> \\
...
\>                                              \> additional file (Ke.dat), using either local ionic temperature from \\
\>                                              \> CIT or system temperature in CETs outside of atomic system \\
\>                                              \> \\
...
\>                                              \> \\
\> {\bf ttm offset} $f$                         \> offsets initial coupling of electronic and ionic systems via \\
\>                                              \> inhomogeneous Langevin thermostat until after $f$ ps (default $f~=~0$) \\
\>                                              \> \\
...
\>                                              \> \\
\> {\bf vdw mix}ing  {\em rule}                 \> apply the mixing {\em rule} to all specified analytical, \\
...
\>                                              \> \\
\> {\bf yml\_rdf}                               \>  print RDFDAT in yml format \\
\>                                              \> \\
\> {\bf yml\_statis}                            \>  print STATIS in yml format \\
\>                                              \> \\
...
\> {\bf l\_vdw}                                 \> dumps to file all tabled vdw interactions in the order \\
\>                                              \> they appear in the field file \\
\>                                              \> \\
\end{tabbing}
...
\>                                              \> \\
\> {\bf io statis} {\it filename}              \> use {\it filename} instead of STATIS \\
\>                                              \> \\
...
\>                                              \> \\
\> {\bf io rdf}  {\it filename}                 \> use {\it filename} instead of RDFDAT \\
\>                                              \> \\
\> {\bf io msd}  {\it filename}                 \> use {\it filename} instead of MSDTMP \\
\>                                              \> \\
\> {\bf io tabbnd}  {\it filename}              \> use {\it filename} instead of TABBND \\
\>                                              \> \\
\> {\bf io tabang}  {\it filename}              \> use {\it filename} instead of TABANG \\
\>                                              \> \\
\> {\bf io tabdih}  {\it filename}              \> use {\it filename} instead of TABDIH \\
\>                                              \> \\
\> {\bf io tabinv}  {\it filename}              \> use {\it filename} instead of TABINV \\
\>                                              \> \\
\> {\bf io vdw}  {\it filename}                 \> use {\it filename} instead of TABLE \\
\>                                              \> \\
\> {\bf io eam}  {\it filename}                 \> use {\it filename} instead of TABEAM \\
\>                                              \> \\
\> {\bf yml\_statis}                            \> statis now is YAML 1.2 compliant \\
\>                                              \> \\
\> {\bf yml\_rdf}                               \> RDFDAT is now YAML 1.2 compliant
\end{tabbing}
