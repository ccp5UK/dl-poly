...
\subsection{DL\_POLY\_Classic features incompatible or unavalable in \D\index{dlpoly2}}
...
Java source code for this GUI is to be found in this sub-directory.
The source is complete and sufficient to create a working GUI,
