...
\index{potential!calcite} This potential \cite{rohl-03a,raiteri} is designed to
...
\item Extended EAM (EEAM) potential ({\bf eeam})\index{potential!EEAM}
...
\begin{enumerate}
\item EAM/EEAM density correction \\
...
\begin{enumerate}
\item EAM/EEAM energy correction \\
No long-ranged corrections apply beyond $r_{\rm met}$.
...
\begin{enumerate}
\item EAM/EEAM virial correction \\
No long-ranged corrections apply beyond $r_{\rm met}$.
...
It is worth noting that in the EEAM potential, all densities
can be different:
\begin{equation}
