Module comms
  ...
  Use mpi_api
#else
  Use mpi, Only: MPI_MAX_PROCESSOR_NAME, MPI_INIT, MPI_INIT_THREAD, MPI_FINALIZE,&
    MPI_BCAST, MPI_BARRIER,MPI_SEND,MPI_IRECV, MPI_GET_ADDRESS, MPI_GET_PROCESSOR_NAME,&
    MPI_GET_VERSION, MPI_GET_LIBRARY_VERSION, MPI_ALLREDUCE, MPI_MIN, MPI_MAX,&
    MPI_MAX_LIBRARY_VERSION_STRING,MPI_SUM,MPI_DOUBLE_PRECISION,MPI_REAL, &
    MPI_REAL8,MPI_REAL16,MPI_RECV,MPI_OFFSET_KIND,MPI_INTEGER, MPI_WTIME,&
    MPI_COMM_SELF,MPI_COMM_NULL,MPI_COMM_RANK,MPI_COMM_WORLD,MPI_COMM_DUP,&
    MPI_COMM_SIZE,MPI_SCATTER,MPI_SCATTERV,MPI_ALLGATHER,MPI_ALLGATHERV,&
    MPI_LOGICAL,MPI_LOR, MPI_CHARACTER,MPI_STATUS_SIZE, MPI_PROD,MPI_ADDRESS_KIND,&
    MPI_LAND,MPI_MODE_WRONLY,MPI_BAND,MPI_BOR,MPI_MODE_RDONLY,MPI_MODE_CREATE,&
    MPI_DOUBLE_PRECISION,MPI_DOUBLE_COMPLEX,MPI_LXOR,MPI_BXOR,MPI_MAXLOC,&
    MPI_MINLOC
