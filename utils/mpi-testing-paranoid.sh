...
cmake ../ -DCMAKE_BUILD_TYPE=Debug -DBUILD_TESTING=ON -DWITH_PLUMED=Off -DBUILDER="Gitlab Worker" -DWITH_EVB=ON && make -j10 && ctest --output-on-failure --timeout 200 -E TEST29
