...
The routine {\sc nve\_0\_vv} implement the
Verlet\index{algorithm!Verlet} algorithm in velocity verlet for free particles and calculate the
...
{\sc nve\_0\_vv}       \> Constant E algorithm\index{ensemble!NVE} \\
{\sc nve\_1\_vv}       \> The same as the above but also incorporating RB integration \\
{\sc dpd\_thermostat}  \> Constant T algorithm\index{ensemble!DPD NVT} (DPD \cite{shardlow-03a}) \\
{\sc nvt\_e0\_vv}      \> Constant $E_{kin}$ algorithm\index{ensemble!Evans NVT} (Evans \cite{evans-84a}) \\
{\sc nvt\_e1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc nvt\_l0\_vv}      \> Constant T algorithm\index{ensemble!Langevin NVT} (Langevin \cite{adelman-76a}) \\
...
{\sc nvt\_a0\_vv}      \> Constant T algorithm\index{ensemble!Andersen NVT} (Andersen \cite{andersen-79a}) \\
{\sc nvt\_a1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc nvt\_b0\_vv}      \> Constant T algorithm\index{ensemble!Berendsen NVT} (Berendsen \cite{berendsen-84a}) \\
{\sc nvt\_b1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc nvt\_h0\_vv}      \> Constant T algorithm\index{ensemble!Nos\'{e}-Hoover NVT} (Hoover \cite{hoover-85a}) \\
{\sc nvt\_h1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc nvt\_g0\_vv}      \> Constant T algorithm\index{ensemble!Gentle Stochastic NVT} (GST \cite{leimkuhler-09a}) \\
{\sc nvt\_g1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc npt\_l0\_vv}      \> Constant T,P algorithm\index{ensemble!Langevin NPT} (Langevin \cite{quigley-04a}) \\
{\sc npt\_l1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc npt\_b0\_vv}      \> Constant T,P algorithm\index{ensemble!Berendsen NPT} (Berendsen \cite{berendsen-84a}) \\
{\sc npt\_b1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc npt\_h0\_vv}      \> Constant T,P algorithm\index{ensemble!Nos\'{e}-Hoover NPT} (Hoover \cite{hoover-85a}) \\
{\sc npt\_h1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc npt\_m0\_vv}      \> Constant T,P algorithm\index{ensemble!Martyna-Tuckerman-Klein NPT} (Martyna-Tuckerman-Klein \cite{martyna-96a}) \\
{\sc npt\_m1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc npt\_l0\_vv}      \> Constant T,$\mat{\sigma}$ algorithm\index{ensemble!Langevin N$\sigma$T} (Langevin \cite{quigley-04a}) \\
{\sc npt\_l1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc nst\_b0\_vv}      \> Constant T,$\mat{\sigma}$ algorithm\index{ensemble!Berendsen N$\sigma$T} (Berendsen \cite{berendsen-84a}) \\
{\sc nst\_b1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc nst\_h0\_vv}      \> Constant T,$\mat{\sigma}$ algorithm\index{ensemble!Nos\'{e}-Hoover N$\sigma$T} (Hoover \cite{hoover-85a}) \\
{\sc nst\_h1\_vv}      \> The same as the above but also incorporating RB integration \\
{\sc nst\_m0\_vv}      \> Constant T,$\mat{\sigma}$ algorithm\index{ensemble!Martyna-Tuckerman-Klein N$\sigma$T} (Martyna-Tuckerman-Klein \cite{martyna-96a}) \\
...
The VV flavour of the Gaussian constraints algorithm is implemented
...
$\Delta t < \sigma_{1}^{2}/\sigma_{2}$~. Happily, one can show that
\begin{equation}
\sigma_{1}^{2}/\sigma_{2} =
...
The VV flavour of the Gentle Stochastic Thermostat is implemented in
...
The VV flavour of the langevin barostat (and Nos\'{e}-Hoover
thermostat) is implemented in the \D routine {\sc npt\_l0\_vv}.
The routine
{\sc npt\_l1\_vv} implements the
same but also incorporate RB dynamics.
...
The isotropic algorithms may be extended to allowing
...
the VV algorithmic equations are, therefore,
...
in the \D routine {\sc npt\_b0\_vv}.
The routines {\sc npt\_b1\_vv} implements the
same but also incorporate RB dynamics.
...
The VV flavour of the Nos\'{e}-Hoover barostat (and thermostat)
is implemented in the \D routine {\sc npt\_h0\_vv}.
The routine {\sc npt\_h1\_vv} implements the
same but also incorporate RB dynamics.
...
The VV flavour of the non-isotropic Nos\'e-Hoover
