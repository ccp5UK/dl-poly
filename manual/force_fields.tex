...
\item MM3 bond stretch potential \cite{allinger-89a}:  ({\bf m3st})
\begin{equation}
...
\end{equation}
\item MM3 angle bend term \cite{alinger-89a}:  ({\bf m3ab})
\begin{eqnarray}
...
only possible for the {\bf 12-6, lj, dpd, 14-7 \& wca} types.
