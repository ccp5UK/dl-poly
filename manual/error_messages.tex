...
\subsubsection*{\underline{Message 671}: error - electronic specific heat not fully specified}
...
\subsubsection*{\underline{Message 672}: error - thermal conductivity of metal not specified}
...
\subsubsection*{\underline{Message 673}: error - thermal diffusivity of non-metal not specified}
...
\subsubsection*{\underline{Message 674}: error - cannot find or open thermal conductivity table file (Ke.dat)}
...
\subsubsection*{\underline{Message 675}: error - no data found in thermal conductivity table file (Ke.dat)}
...
\subsubsection*{\underline{Message 676}: error - cannot find or open volumetric heat capacity table file (Ce.dat)}
...
\subsubsection*{\underline{Message 677}: error - no data found in volumetric heat capacity table file (Ce.dat)}
...
\subsubsection*{\underline{Message 678}: error - cannot find or open thermal diffusivity table file (De.dat)}
...
\subsubsection*{\underline{Message 679}: error - no data found in thermal diffusivity table file (De.dat)}
...
\subsubsection*{\underline{Message 680}: error - cannot find or open coupling constant table file (g.dat)}
...
\subsubsection*{\underline{Message 681}: error - no data found in coupling constant table file (g.dat)}
...
\subsubsection*{\underline{Message 682}: error - end of file encountered in table file (Ke.dat, Ce.dat, De.dat or g.dat)}
...
\subsubsection*{\underline{Message 683}: error - negative electronic temperature: instability in electronic heat diffusion equation}
...
\subsubsection*{\underline{Message 684}: error - electronic temperature restart file (DUMP\_E) does not exist}
...
\subsubsection*{\underline{Message 685}: error - mismatch in electronic temperature lattice sizes between restart (DUMP\_E) and CONTROL files}
...
\subsubsection*{\underline{Message 686}: error - cannot read electronic temperature restart (DUMP\_E) file}
