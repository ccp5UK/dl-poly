...
\begin{tabbing}
X\=XXXXXXXXXXXX\=XXXXXXXXXXXX\=\kill
\> {\tt charge}       \> real(1)  \> scalar \\
\> {\tt dipole}       \> real(3)  \> vector (x,y,z) \\
\> {\tt quadrupole}   \> real(6)  \> vector (xx,xy,xz,yy,yz,zz) \\
\> {\tt octupole}     \> real(10) \> vector (xxx,xxy,xxz,xyy,xyz,xzz,yyy,yyz,yzz,zzz) \\
\> {\tt hexadecapole} \> real(15) \> vector (xxxx,xxxy,xxxz,....,yyyz,yyzz,yzzz,zzzz) \\
\end{tabbing}
