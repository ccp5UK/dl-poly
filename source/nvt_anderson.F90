...
Contains
  ...
  Subroutine nvt_a0_vv(stage, lvar, mndis, mxdis, mxstp, tstep, nstep, &
    ...
    Real(Kind=wp)              :: hstep, mxdr, rstep, scale, tkin, tmp, vom(1:3)
...
! q. index arrays and tp. sum arrays
    ...
    Allocate (qn(1:config%nlast), tpn(0:comm%mxnode - 1), Stat=fail(10))
  ...
  Subroutine nvt_a1_vv(stage, lvar, mndis, mxdis, mxstp, tstep, nstep, &
    ...
    Real(Kind=wp)              :: fmx, fmy, fmz, hstep, mxdr, opx, opy, opz, p0, p1, p2, p3, qt0, &
                                  qt1, qt2, qt3, rot(1:9), rstep, scale, tkin, tmp, tqx, tqy, tqz, &
...
! q. index arrays and tp. sum arrays
    ...
    Allocate (qn(1:config%nlast), tpn(0:comm%mxnode - 1), Stat=fail(15))
