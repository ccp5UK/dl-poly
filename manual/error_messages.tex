...
\subsubsection*{\underline{Message 22}: error - unsuitable radial increment in TABLE||TABBND||TABANG||TABDIH||TABINV file}
...
intramolecular interactions that are possibly supplied via the
...
\subsubsection*{\underline{Message 24}: error - end of file encountered in TABLE||TABEAM||TABBND||TABANG||TABDIH||TABINV file}

This means the TABLE||TABEAM||TABBND||TABANG||TABDIH||TABINV file
...
\subsubsection*{\underline{Message 138}: error - incorrect atom totals in refresh\_halo\_positions}
...
\subsubsection*{\underline{Message 163}: error - statistics\_connect\_spread outgoing transfer buffer exceeded}
...
\subsubsection*{\underline{Message 164}: error - statistics\_connect\_spread incoming transfer buffer exceeded}
...
\subsubsection*{\underline{Message 172}: error - duplicate intra-molecular entries specified in TABBND||TABANG||TABDIH||TABINV}
...
\subsubsection*{\underline{Message 504}: error - cutoff too large for TABLE||TABBND file}
...
A bond with potential defined in TABBND or for which intramolecular
...
\subsubsection*{\underline{Message 1078}: error - allocation failure in inversions\_module -> allocate\_invr\_dst\_arrays}
