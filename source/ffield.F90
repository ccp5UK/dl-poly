...
! Average maximum number of intra-like bonds per atom
  ...
  Subroutine read_mpoles(l_top, sumchg, cshell, sites, mpoles, comm)
    ...
    Integer            :: i, indmpl, indmpl_final, indmpl_start, ishls, isite, isite2, itmols, j, &
                          jsite, k, kshels, ksite, l, lsite, nrept, nshels, nsite, ordmpl, &
                          ordmpl_max, ordmpl_min, ordmpl_next, ordmpl_start, sitmpl
    Logical            :: l_ord, l_rsh, safe
    Real(Kind=wp)      :: charge, dumping, polarity, scl
