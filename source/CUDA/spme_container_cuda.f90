...
! 20090120/ck: ranged version of bspgen to be overlapped with the cuda counterpart.
!
Subroutine bspgen_helper(iatmb,iatme,nospl,xxx,yyy,zzz,bspx,bspy,bspz,bsdx,bsdy,bsdz)
  ...
  If (fail > 0) Then
     Write(nrite,'(/,1x,a,i0)') 'bspgen_helper allocation failure, node', idnode
     Call error(0)
  End If
...
!$OMP PARALLEL DO PRIVATE(i,rix0,riy0,riz0,k_r,km1_rr,jm1_r,aaa,bbb,ccc,k)
  Do i=iatmb,iatme
