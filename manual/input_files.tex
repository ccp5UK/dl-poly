...
crd i j k Defines the atomic pairs to use for both coordination and angular distribution, followed by is i + j + k records:
...
k number of the following pattern: atom atom ‘-‘ atom
