...
cmake ../ -DCMAKE_BUILD_TYPE=Debug -DBUILD_TESTING=ON -DWITH_PLUMED=Off -DBUILDER="Gitlab Worker" -DWITH_EVB=On && make -j10 && ctest --output-on-failure -E TEST2[89]  --timeout 200
