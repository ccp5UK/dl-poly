Module errors_warnings
  ...
  Subroutine warning(kode,a,b,c,comm)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  If (comm%idnode == 0) Then
     ...
     Else If (kode == 1016) Then
        ...
        Write(nrite,'(/,1x,a)') 'error - allocation failure in statistics -> allocate_statitics_arrays'
     ...
     Else If (kode == 1060) Then
        ...
        Write(nrite,'(/,1x,a)') 'error - allocation failure in statistics -> allocate_statitics_connect'

     Else If (kode == 1061) Then

        Write(nrite,'(/,1x,a)') 'error - allocation failure in statistics -> deallocate_statitics_connect'
