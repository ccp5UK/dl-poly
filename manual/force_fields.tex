...
All shell models\index{polarisation!shell model} can be used in
...
in the VDW section.  In order to use openKIM functionality within \D one must
further ensure that \D is cross-compiled with openKIM.  For guidance on this
together with testing, please refer to {\sc README\_KIM.txt} in {\em source}
and follow instructions within.
