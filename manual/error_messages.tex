...
is corrupted.  Check out for mangled/blank lines in CONFIG/HISTORY, or
blank line/s at the end or missing End of Line character in CONFIG.  If
this error is issued after timestep zero in a simulation that is not
replaying HISTORY then it is big trouble and you may report that to the
authors.  If it is during replaying HISTORY then your HISTORY file has
corrupted frames and you must correct it before tring again.
