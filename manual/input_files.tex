...
\>                                              \> \\
\> *** IO Custom ***                            \> *** IO CUSTOM *** \\
\> {\bf output} {\it filename}                \> Will use {\it filename} instead of OUTPUT \\
\> {\bf config} {\it filename}                \> Will use {\it filename} instead of CONFIG \\
\> {\bf field} {\it filename}                 \> Will use {\it filename} instead of FIELD \\
\> {\bf outstat} {\it filename}                 \> Will use {\it filename} instead of STATIS \\
\> {\bf history} {\it filename}                 \> Will use {\it filename} instead of HISTORY \\
\> {\bf historf} {\it filename}                 \> Will use {\it filename} instead of HISTORF \\
\> {\bf revive} {\it filename}                 \> Will use {\it filename} instead of REVIVE \\
\> {\bf revold} {\it filename}                 \> Will use {\it filename} instead of REVOLD \\
\> {\bf revcon} {\it filename}                 \> Will use {\it filename} instead of REVCON \\
\end{tabbing}
...
$U(r) = 4 \epsilon \left[ \left( \frac{\sigma}{r} \right)^{12} - \left( \frac{\sigma}{r}\right)^{6} \right]$ \\
           &                           &            &          &          &         &                      & \\
{\bf lj}   & Lennard-Jones cohesive \cite{barrat-99a} & $\epsilon$ & $\sigma$ & $c$      &         &       &
