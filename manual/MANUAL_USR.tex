...
\date{\bf Version 4.11~~--~~October 2020}
\clearpage
\end{titlepage}
...
\chapter{Extenting DL\_POLY\_4 to reactive systems: the Empirical Valence Bond method}
\label{evb}
{\bf Author}: Dr. Ivan Scivetti\\
\vskip 12ex
\section*{Scope of Chapter}
This chapter presents the theoretical fundamentals of the Empirical Valence Bond (EVB) method and its implementation into the DL\_POLY\_4 code. This new feature allows to perform molecular dynamics simulations of reactive processes via the use of standard (non-reactive) force-fields.
\setcounter{equation}{0}
\newpage
