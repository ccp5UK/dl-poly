...
Standard user response.  Increase {\tt mxgrid} parameters
...
\subsubsection*{\underline{Message 162}: error - statistics\_connect\_spread outgoing transfer buffer exceeded}
...
\subsubsection*{\underline{Message 1060}: error - allocation failure in statistics\_module -> allocate\_statitics\_connect\_arrays}

\noindent \underline{\em Action}:

See Message 1001
\subsubsection*{\underline{Message 1061}: error - allocation failure in statistics\_module -> deallocate\_statitics\_connect\_arrays}
